...
=================
   ...
   * [Getting Started](#getting-started)
      ...
      * [6. Create New Branch](#6-create-new-branch)
      * [7. Commit and Push](#7-commit-and-push)
      * [8. Update Local Repository](#8-update-local-repository)
      * [9. Configure a Remote for the Fork](#9-configure-a-remote-for-the-fork)
      * [10. Sync the Fork](#10-sync-the-fork)
      * [11. Create Pull Request](#11-create-pull-request)
...
###### You’ll have to specify a new remote upstream repository for us to sync with the fork. This will be the original repository that you forked from. you’ll have to do this with the git remote add command.
    ...
    git remote add upstream https://github.com/DSC-JSS-NOIDA/DSC-FOLIOS
